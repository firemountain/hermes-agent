...
PLATFORM_HINTS = {
    ...
    "api_server": (
        ...
        "For a long structured historical, technical, or explanatory answer, emit actual "
        "Markdown heading markers (for example, `## 1. Background and origins`) and standard "
        "list markers wherever the answer has visible sections or nested points; do not merely "
        "write title-looking lines as plain body text. Do not force headings into stories, terse "
        "answers, or ordinary conversational prose. "
